<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="OSCAL_SAR_Mapper._Default" %>
   ...
   <script type="text/javascript">
    ...
    <div class="row" onchange ="scrollUp()">
        <div class="col-md-8" runat="server"  >
            <h2>Upload OSCAL SAR XML File</h2>
            <p>
                &nbsp;Browse to the OSCAL SAR Version 1.0.0 XML file and click upload
                to start process.</p>
            <p>
            ...
            <asp:PostBackTrigger ControlID="UploadButton" />
             ...
             <asp:Button ID="OpenMyFile" runat="server" OnClick="OpenMyFile_Click" Text="Download Word SAR Document" Visible="False" />
